 ...
 * @generated
 */
public class TemplateLanguageSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case TemplateLanguagePackage.TABLE_DATA:
      {
        ...
        if (result == null) result = caseFeature(tableData);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        TableDataAttribute tableDataAttribute = (TableDataAttribute)theEObject;
        T result = caseTableDataAttribute(tableDataAttribute);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case TemplateLanguagePackage.LIST_ATTRIBUTE:
      {
        ListAttribute listAttribute = (ListAttribute)theEObject;
        T result = caseListAttribute(listAttribute);
        if (result == null) result = caseTableDataAttribute(listAttribute);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Table Data Attribute</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Table Data Attribute</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseTableDataAttribute(TableDataAttribute object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseListAttribute(ListAttribute object)
  {
    return null;
  }
